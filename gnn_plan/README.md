...
See [`_prep/REVIEW_AND_PIVOT.md`](_prep/REVIEW_AND_PIVOT.md) for why the deck was split:
...
2. [`_prep/REVIEW_AND_PIVOT.md`](_prep/REVIEW_AND_PIVOT.md) — external review, slop
   diagnosis, and the HATCH-IoU pivot. Read this before the older docs so
   the rest is filtered through the current narrowing.
3. [`_prep/TALK_TRACK.md`](_prep/TALK_TRACK.md) — single-page talk track for the
...
- [`_prep/SENSEMAKING.md`](_prep/SENSEMAKING.md) consolidates the useful generated support
