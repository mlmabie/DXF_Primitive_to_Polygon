...
| Reference prompt | Source lead to review; not yet load-bearing. | paper/source entries in `_prep/07_source_review_prompts.md` |
...
For each source in [`_prep/07_source_review_prompts.md`](_prep/07_source_review_prompts.md),
