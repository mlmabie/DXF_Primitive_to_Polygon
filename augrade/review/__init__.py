...
These are the HITL-side of augrade. They are kept in a subpackage so the
core extraction and library can be understood and audited without reading
through ~2500 lines of HTML generator.
